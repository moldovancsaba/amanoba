...
**Counts**: KEEP=132, MERGE=0, ARCHIVE=0, DELETE=0
...
| KEEP | `docs/amanoba_codex_brain_dump.md` | Amanoba Codex Brain Dump (Continuity Doc) | 4.3 KB | — | Listed in DOCS_INDEX.md (core docs section). |
| KEEP | `docs/amanoba_course_content_standard_v1_0.md` | AMANOBA COURSE CONTENT STANDARD v1.0 (Markdown-first) | 13.2 KB | — | Unclassified; keep pending human review. |
...
| KEEP | `docs/ASSESSMENT_GAME_ID_MIGRATION.md` | assessmentGameId Migration Plan | 1.4 KB | — | Unclassified; keep pending human review. |
...
| KEEP | `docs/course_ideas/amanoba_course_sport_sales_network_usa_2026_questions.md` | amanoba course sport sales network usa 2026 questions | 51.3 KB | — | Working notes (reference-only course ideation). |
| KEEP | `docs/course_ideas/amanoba_course_sport_sales_network_usa_2026.md` | Build a Sport Sales Network in the USA 2026 | 19.9 KB | — | Working notes (reference-only course ideation). |
...
| KEEP | `docs/COURSE_PACKAGE_FORMAT.md` | Course package format (v2) | 7.7 KB | — | Unclassified; keep pending human review. |
...
| KEEP | `docs/course_runs/PRODUCTIVITY_2026_EN__2026-01-26T23-09-28Z.md` | Run Log — PRODUCTIVITY_2026_EN — Quiz Quality Audit (Dry Run) | 5.5 KB | — | Course run logs / execution reference. |
| KEEP | `docs/course_runs/PRODUCTIVITY_2026_HU__2026-01-27T10-55-27Z.md` | Course Run Log — PRODUCTIVITY_2026_HU (Production) | 7.8 KB | — | Course run logs / execution reference. |
| KEEP | `docs/course_runs/QUALITY_CHECK__2026-01-28T21-43Z.md` | Quality Check Run Log | 3.6 KB | — | Course run logs / execution reference. |
...
| KEEP | `docs/RELEASE_NOTES.md` | Amanoba Release Notes | 157.9 KB | — | Listed in DOCS_INDEX.md (core docs section). |
...
| KEEP | `docs/REPHRASE_RULES_HU.md` | Rephrase rules — Hungarian (HU) | 1.6 KB | — | Unclassified; keep pending human review. |
| KEEP | `docs/REPHRASE_RULES_ID.md` | Rephrase rules — Indonesian (ID) | 568 B | — | Unclassified; keep pending human review. |
| KEEP | `docs/REPHRASE_RULES_PL.md` | Rephrase rules — Polish (PL) | 926 B | — | Unclassified; keep pending human review. |
| KEEP | `docs/REPHRASE_RULES_PT.md` | Rephrase rules — Portuguese (PT) | 568 B | — | Unclassified; keep pending human review. |
| KEEP | `docs/REPHRASE_RULES_RU.md` | Rephrase rules — Russian (RU) | 663 B | — | Unclassified; keep pending human review. |
| KEEP | `docs/REPHRASE_RULES_TR.md` | Rephrase rules — Turkish (TR) | 562 B | — | Unclassified; keep pending human review. |
| KEEP | `docs/REPHRASE_RULES_VI.md` | Rephrase rules — Vietnamese (VI) | 542 B | — | Unclassified; keep pending human review. |
| KEEP | `docs/ROADMAP_TASKLIST_SYSTEM_COMPARISON.md` | ROADMAP vs TASKLIST vs System Outline — Comparison | 5.7 KB | — | Unclassified; keep pending human review. |
| KEEP | `docs/ROADMAP.md` | Amanoba Roadmap — Future Vision & Client Benefits | 4.4 KB | — | Listed in DOCS_INDEX.md (core docs section). |
| KEEP | `docs/SSO_ALIGNMENT_ANALYSIS.md` | SSO Alignment Analysis & Refactoring Plan | 9.5 KB | — | Unclassified; keep pending human review. |
| KEEP | `docs/SSO_CLIENT_ID_UPDATE.md` | SSO Client ID Update | 2.7 KB | — | Unclassified; keep pending human review. |
| KEEP | `docs/SSO_CLIENT_SIDE_INSTRUCTIONS.md` | SSO Client-Side Instructions for Amanoba Agent | 5.3 KB | — | Unclassified; keep pending human review. |
| KEEP | `docs/SSO_ENVIRONMENT_VARIABLES.md` | SSO Environment Variables | 6.3 KB | — | Unclassified; keep pending human review. |
| KEEP | `docs/SSO_FOUNDATION_COMPLETE.md` | SSO Foundation - Phase 1 Complete ✅ | 5.6 KB | — | Unclassified; keep pending human review. |
| KEEP | `docs/SSO_IMPLEMENTATION_DETAILS.md` | SSO Implementation Details — Amanoba Platform | 14.9 KB | — | Unclassified; keep pending human review. |
...
| KEEP | `docs/WARP.DEV_AI_CONVERSATION.md` | Amanoba Development Planning Log | 17.1 KB | — | Reference notes (kept but not canonical). |
| KEEP | `docs/WARP.md` | Amanoba – AI Assistant Guide (WARP.md) | 11.9 KB | — | Reference notes (kept but not canonical). |
