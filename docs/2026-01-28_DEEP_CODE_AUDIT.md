...
- **Rollback**: Revert commits that only touch docs (`docs/2026-01-28_DEEP_CODE_AUDIT.md`, `docs/ROADMAP.md`, `docs/TASKLIST.md`, `agent_working_loop_canonical_operating_document.md`).  
