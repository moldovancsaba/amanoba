...
**Naming**: Files and directories use **kebab-case**. Code: **camelCase** (vars, functions), **PascalCase** (components, types, classes). See `docs/core/NAMING_GUIDE.md`.

---

## 2. Documentation layout

- **Feature documents**: `/docs/core/templates/FEATURE_TEMPLATE.md`. Referenced from TASKLIST, ROADMAP, RELEASE_NOTES, ARCHITECTURE, LEARNINGS as needed.
