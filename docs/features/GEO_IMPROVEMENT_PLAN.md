...
**Actionable tasks:** Implementation is broken down in **`docs/product/TASKLIST.md`** under **P3 — Public lesson view pages (GEO)** (API, route, layout, metadata, canonical/noindex, sitemap, no-internal-links policy).
