...
- learners can save lesson days from the enrolled lesson view
...
Saved content should reflect learning intent, not generic web-style bookmarking. The first save unit is therefore a `course lesson day`, because it is the smallest meaningful revisit target in the current Amanoba flow.

## Learner workflow

1. The learner opens an enrolled lesson day.
2. The learner saves that lesson day for later review.
...
- the learner's current course day
- a saved-lesson href
...
- confirm learners can save and unsave a lesson day
- confirm `Saved Lessons` lists saved items for the authenticated learner
- confirm each item links both to the saved lesson day and to the learner's current course position
