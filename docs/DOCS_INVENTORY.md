...
| `docs/ASSESSMENT_GAME_ID_MIGRATION.md` | assessmentGameId Migration Plan | 1.4 KB |
...
| `docs/course_ideas/amanoba_course_sport_sales_network_usa_2026_questions.md` | amanoba course sport sales network usa 2026 questions | 51.3 KB |
| `docs/course_ideas/amanoba_course_sport_sales_network_usa_2026.md` | Build a Sport Sales Network in the USA 2026 | 19.9 KB |
...
| `docs/course_runs/PRODUCTIVITY_2026_EN__2026-01-26T23-09-28Z.md` | Run Log — PRODUCTIVITY_2026_EN — Quiz Quality Audit (Dry Run) | 5.5 KB |
| `docs/course_runs/PRODUCTIVITY_2026_HU__2026-01-27T10-55-27Z.md` | Course Run Log — PRODUCTIVITY_2026_HU (Production) | 7.8 KB |
| `docs/course_runs/QUALITY_CHECK__2026-01-28T21-43Z.md` | Quality Check Run Log | 3.6 KB |
...
| `docs/REPHRASE_RULES_HU.md` | Rephrase rules — Hungarian (HU) | 1.6 KB |
| `docs/REPHRASE_RULES_ID.md` | Rephrase rules — Indonesian (ID) | 568 B |
| `docs/REPHRASE_RULES_PL.md` | Rephrase rules — Polish (PL) | 926 B |
| `docs/REPHRASE_RULES_PT.md` | Rephrase rules — Portuguese (PT) | 568 B |
| `docs/REPHRASE_RULES_RU.md` | Rephrase rules — Russian (RU) | 663 B |
| `docs/REPHRASE_RULES_TR.md` | Rephrase rules — Turkish (TR) | 562 B |
| `docs/REPHRASE_RULES_VI.md` | Rephrase rules — Vietnamese (VI) | 542 B |
| `docs/ROADMAP_TASKLIST_SYSTEM_COMPARISON.md` | ROADMAP vs TASKLIST vs System Outline — Comparison | 5.7 KB |
| `docs/ROADMAP.md` | Amanoba Roadmap — Future Vision & Client Benefits | 4.4 KB |
| `docs/SSO_ALIGNMENT_ANALYSIS.md` | SSO Alignment Analysis & Refactoring Plan | 9.5 KB |
| `docs/SSO_CLIENT_ID_UPDATE.md` | SSO Client ID Update | 2.7 KB |
| `docs/SSO_CLIENT_SIDE_INSTRUCTIONS.md` | SSO Client-Side Instructions for Amanoba Agent | 5.3 KB |
| `docs/SSO_ENVIRONMENT_VARIABLES.md` | SSO Environment Variables | 6.3 KB |
| `docs/SSO_FOUNDATION_COMPLETE.md` | SSO Foundation - Phase 1 Complete ✅ | 5.6 KB |
| `docs/SSO_IMPLEMENTATION_DETAILS.md` | SSO Implementation Details — Amanoba Platform | 14.9 KB |
...
| `docs/WARP.DEV_AI_CONVERSATION.md` | Amanoba Development Planning Log | 17.1 KB |
| `docs/WARP.md` | Amanoba – AI Assistant Guide (WARP.md) | 11.9 KB |
