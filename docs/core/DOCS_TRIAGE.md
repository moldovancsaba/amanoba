...
**Counts**: DELETE=0, MERGE=0, ARCHIVE=4, KEEP(unclassified)=64
...
- `docs/certification/certification_final_exam_plan_v2.md` — certification_final_exam_plan.md
- `docs/certification/certification_final_exam_plan_v3.md` — certification_final_exam_plan_v3.md
...
- After updates, rerun `npm run docs:refresh` and ensure `docs/core/DOCS_INDEX.md` remains current.
