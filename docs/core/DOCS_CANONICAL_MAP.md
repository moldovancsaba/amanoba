...
| KEEP | `docs/HANDOVER.md` | Amanoba — Developer Handover | 88.5 KB | — | Listed in DOCS_INDEX.md (feature/reference section). |
...
| ARCHIVE | `docs/quality/UI_LAYOUT_GRAMMAR_AUDIT.md` | UI Layout Grammar Audit | 22.9 KB | `docs/_archive/reference/` | Process/delivery doc; keep for context but treat as non-canonical. |
