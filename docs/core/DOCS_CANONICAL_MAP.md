...
| KEEP | `docs/core/CODING_STANDARDS.md` | Amanoba Coding Standards | 5.1 KB | — | Listed in DOCS_INDEX.md (core docs section). |
...
| KEEP | `docs/HANDOVER.md` | Amanoba — Developer Handover | 123.3 KB | — | Listed in DOCS_INDEX.md (feature/reference section). |
...
| KEEP | `docs/product/PATTERN_CONTRACT_INVENTORY.md` | Amanoba Pattern Contract Inventory | 3.7 KB | — | Listed in DOCS_INDEX.md (feature/reference section). |
