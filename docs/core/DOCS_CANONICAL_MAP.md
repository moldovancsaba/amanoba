...
| KEEP | `docs/core/amanoba_codex_brain_dump.md` | Amanoba Codex Brain Dump | 5.5 KB | — | Listed in DOCS_INDEX.md (core docs section). |
...
| KEEP | `docs/HANDOVER.md` | Amanoba — Developer Handover | 78.4 KB | — | Listed in DOCS_INDEX.md (feature/reference section). |
