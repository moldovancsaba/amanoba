...
**Counts**: KEEP=86, MERGE=0, ARCHIVE=4, DELETE=0
...
| KEEP | `docs/architecture/ARCHITECTURE.md` | Amanoba Architecture | 37.7 KB | — | Listed in DOCS_INDEX.md (core docs section). |
| KEEP | `docs/architecture/layout_grammar.md` | Amanoba Layout Grammar | 11.0 KB | — | Listed in DOCS_INDEX.md (core docs section). |
...
| KEEP | `docs/core/DOCS_INVENTORY.md` | Docs Inventory | 8.3 KB | — | Unclassified; keep pending human review. |
...
| KEEP | `docs/handoff/AmanobaAuditDocMapping.md` | Amanoba Audit: Document ↔ Code Inventory | 6.9 KB | — | Unclassified; keep pending human review. |
...
| ARCHIVE | `docs/HANDOVER.md` | Amanoba — Developer Handover | 8.7 KB | `docs/_archive/reference/` | Process/delivery doc; keep for context but treat as non-canonical. |
...
| KEEP | `docs/product/DESIGN_UPDATE.md` | Design System Update - New Brand Colors & Logo | 4.4 KB | — | Unclassified; keep pending human review. |
...
| KEEP | `docs/product/RELEASE_NOTES.md` | Amanoba Release Notes | 171.5 KB | — | Listed in DOCS_INDEX.md (core docs section). |
