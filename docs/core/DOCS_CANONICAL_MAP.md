...
| KEEP | `docs/core/CODING_STANDARDS.md` | Amanoba Coding Standards | 4.5 KB | — | Listed in DOCS_INDEX.md (core docs section). |
...
| KEEP | `docs/core/DOCS_INVENTORY.md` | Docs Inventory | 9.0 KB | — | Unclassified; keep pending human review. |
...
| KEEP | `docs/core/WARP.md` | Amanoba – AI Assistant Guide (WARP.md) | 12.5 KB | — | Reference notes (kept but not canonical). |
...
| KEEP | `docs/handoff/AmanobaAuditDocMapping.md` | Amanoba Audit: SSOT Inventory | 7.2 KB | — | Listed in DOCS_INDEX.md (feature/reference section). |
...
| KEEP | `docs/HANDOVER.md` | Amanoba — Developer Handover | 67.5 KB | — | Listed in DOCS_INDEX.md (feature/reference section). |
...
| KEEP | `docs/product/DESIGN_UPDATE.md` | Design System Adapter Status | 4.0 KB | — | Listed in DOCS_INDEX.md (feature/reference section). |
...
| ARCHIVE | `docs/quality/UI_FOUNDATION_AUDIT.md` | UI Foundation Audit (Hard Rules) | 1.5 KB | `docs/_archive/reference/` | Process/delivery doc; keep for context but treat as non-canonical. |
