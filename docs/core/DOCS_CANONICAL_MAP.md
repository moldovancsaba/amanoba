...
**Counts**: KEEP=93, MERGE=0, ARCHIVE=4, DELETE=0
...
| KEEP | `docs/architecture/ARCHITECTURE_GAP_ANALYSIS.md` | ARCHITECTURE_GAP_ANALYSIS.md | 8.7 KB | — | Unclassified; keep pending human review. |
| KEEP | `docs/architecture/ARCHITECTURE.md` | Amanoba Architecture | 38.6 KB | — | Listed in DOCS_INDEX.md (core docs section). |
...
| KEEP | `docs/certification/certification_final_exam_plan_v2.md` | certification_final_exam_plan.md | 10.7 KB | — | Unclassified; keep pending human review. |
| KEEP | `docs/certification/certification_final_exam_plan_v3.md` | certification_final_exam_plan_v3.md | 12.0 KB | — | Unclassified; keep pending human review. |
...
| KEEP | `docs/core/CODING_STANDARDS.md` | Amanoba Coding Standards | 3.5 KB | — | Unclassified; keep pending human review. |
...
| KEEP | `docs/core/DOCS_TRIAGE.md` | Docs Triage | 5.8 KB | — | Unclassified; keep pending human review. |
...
| KEEP | `docs/core/TECH_STACK.md` | Technology Stack | 3.3 KB | — | Unclassified; keep pending human review. |
...
| KEEP | `docs/features/NEWS_POSTS_MVP.md` | News Posts MVP | 2.3 KB | — | Unclassified; keep pending human review. |
...
| KEEP | `docs/features/SAVED_LESSONS_MVP.md` | Saved Lessons MVP | 2.5 KB | — | Unclassified; keep pending human review. |
| KEEP | `docs/handoff/AmanobaAuditDocMapping.md` | Amanoba Audit: SSOT Inventory | 14.0 KB | — | Listed in DOCS_INDEX.md (feature/reference section). |
...
| ARCHIVE | `docs/HANDOVER.md` | Amanoba — Developer Handover | 59.9 KB | `docs/_archive/reference/` | Process/delivery doc; keep for context but treat as non-canonical. |
...
| KEEP | `docs/product/DESIGN_UPDATE.md` | Design System Status | 4.4 KB | — | Unclassified; keep pending human review. |
...
| KEEP | `docs/product/NEXT_PHASES.md` | Next Phases: Detailed Implementation Plan | 13.3 KB | — | Unclassified; keep pending human review. |
| KEEP | `docs/product/P3_KNOWN_ISSUES_BACKLOG.md` | P3 Known Issues — Backlog | 2.0 KB | — | Unclassified; keep pending human review. |
| KEEP | `docs/product/RELEASE_NOTES.md` | Amanoba Release Notes | 175.1 KB | — | Listed in DOCS_INDEX.md (core docs section). |
...
| KEEP | `docs/product/ROADMAP.md` | Amanoba Roadmap — Future Vision & Client Benefits | 5.2 KB | — | Listed in DOCS_INDEX.md (core docs section). |
| KEEP | `docs/product/TASKLIST.md` | Amanoba Task List | 13.5 KB | — | Listed in DOCS_INDEX.md (core docs section). |
...
| KEEP | `docs/quality/PHASE_2_AUDIT_TRACKER.md` | PHASE 2 AUDIT - COURSES 2-8 | 3.1 KB | — | Unclassified; keep pending human review. |
...
| KEEP | `docs/README.md` | Amanoba Docs | 2.1 KB | — | Unclassified; keep pending human review. |
...
| KEEP | `docs/status/PRODUCTION_STATUS.md` | Production Status | 1.9 KB | — | Listed in DOCS_INDEX.md (feature/reference section). |
