...
**Counts**: KEEP=92, MERGE=0, ARCHIVE=4, DELETE=0
...
| KEEP | `docs/architecture/ARCHITECTURE.md` | Amanoba Architecture | 38.3 KB | — | Listed in DOCS_INDEX.md (core docs section). |
| KEEP | `docs/architecture/layout_grammar.md` | Amanoba Layout Grammar | 12.2 KB | — | Listed in DOCS_INDEX.md (core docs section). |
...
| KEEP | `docs/core/DOCS_CANONICAL_MAP.md` | Docs Canonicalization Map | 14.6 KB | — | Unclassified; keep pending human review. |
...
| KEEP | `docs/features/NEWS_POSTS_MVP.md` | News Posts MVP | 1.9 KB | — | Unclassified; keep pending human review. |
...
| ARCHIVE | `docs/HANDOVER.md` | Amanoba — Developer Handover | 54.0 KB | `docs/_archive/reference/` | Process/delivery doc; keep for context but treat as non-canonical. |
...
| KEEP | `docs/product/DESIGN_UPDATE.md` | Design System Status | 3.7 KB | — | Unclassified; keep pending human review. |
...
| KEEP | `docs/product/RELEASE_NOTES.md` | Amanoba Release Notes | 172.7 KB | — | Listed in DOCS_INDEX.md (core docs section). |
