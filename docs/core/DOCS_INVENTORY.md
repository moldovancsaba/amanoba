...
| `docs/core/agent_working_loop_canonical_operating_document.md` | Amanoba — Agent Operating Document | 30.8 KB |
| `docs/core/amanoba_codex_brain_dump.md` | Amanoba Codex Brain Dump | 1.9 KB |
...
| `docs/handoff/feature_issues/DOC_SSOT_GDS_CLOSURE_PROGRAM.md` | Amanoba Doc SSOT + GDS Closure Program | 4.3 KB |
...
| `docs/HANDOVER.md` | Amanoba — Developer Handover | 139.6 KB |
...
| `docs/product/DESIGN_UPDATE.md` | Design System Adapter Status | 6.9 KB |
