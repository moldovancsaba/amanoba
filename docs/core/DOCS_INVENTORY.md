...
| `docs/core/CODING_STANDARDS.md` | Amanoba Coding Standards | 5.1 KB |
...
| `docs/HANDOVER.md` | Amanoba — Developer Handover | 123.3 KB |
...
| `docs/product/PATTERN_CONTRACT_INVENTORY.md` | Amanoba Pattern Contract Inventory | 3.7 KB |
