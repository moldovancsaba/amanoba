<!--
  ...
  Regenerate via: node --import tsx scripts/docs/generate-docs-inventory.ts
-->
...
| `docs/architecture/ARCHITECTURE.md` | Amanoba Architecture | 38.8 KB |
...
| `docs/certification/certification_final_exam_plan_v2.md` | certification_final_exam_plan.md | 10.8 KB |
| `docs/certification/certification_final_exam_plan_v3.md` | certification_final_exam_plan_v3.md | 12.2 KB |
| `docs/certification/certification_final_exam_plan_v4.md` | certification_final_exam_plan_v4.md | 14.2 KB |
...
| `docs/core/amanoba_codex_brain_dump.md` | Amanoba Codex Brain Dump | 6.2 KB |
...
| `docs/core/CONTRIBUTING.md` | Contributing to Amanoba | 14.1 KB |
| `docs/core/CROSS_REPO_DOCS.md` | Cross-Repo Documentation References | 1.7 KB |
| `docs/core/DOCS_CANONICAL_MAP.md` | Docs Canonicalization Map | 17.5 KB |
| `docs/core/DOCS_INDEX.md` | Documentation index | 6.9 KB |
| `docs/core/DOCS_INVENTORY.md` | Docs Inventory | 10.4 KB |
...
| `docs/features/NEWS_POSTS_MVP.md` | News Posts MVP | 2.2 KB |
...
| `docs/handoff/AmanobaAuditDocMapping.md` | Amanoba Audit: SSOT Inventory | 8.0 KB |
...
| `docs/handoff/feature_issues/GDS_2_3_ADOPTION_PROGRAM.md` | GDS 2.3.0 Rock-Solid Adoption Program (Amanoba) | 2.3 KB |
| `docs/handoff/feature_issues/gds-2.3-bodies/00-epic.md` | 00-epic | 5.2 KB |
| `docs/handoff/feature_issues/gds-2.3-bodies/01-docs.md` | 01-docs | 4.4 KB |
| `docs/handoff/feature_issues/gds-2.3-bodies/02-packages.md` | 02-packages | 3.5 KB |
| `docs/handoff/feature_issues/gds-2.3-bodies/03-theme.md` | 03-theme | 4.0 KB |
| `docs/handoff/feature_issues/gds-2.3-bodies/04-shells.md` | 04-shells | 3.2 KB |
| `docs/handoff/feature_issues/gds-2.3-bodies/05-metrics-states.md` | 05-metrics-states | 3.2 KB |
| `docs/handoff/feature_issues/gds-2.3-bodies/06-admin-data.md` | 06-admin-data | 3.1 KB |
...
| `docs/HANDOVER.md` | Amanoba — Developer Handover | 126.5 KB |
...
| `docs/product/DESIGN_UPDATE.md` | Design System Adapter Status | 7.4 KB |
| `docs/product/DEVELOPER_FEEDBACK_ANALYSIS.md` | Developer Feedback Analysis | 7.2 KB |
| `docs/product/GDS_ADOPTION_MANIFEST.md` | Amanoba GDS Adoption Manifest | 6.5 KB |
...
| `docs/product/PATTERN_CONTRACT_INVENTORY.md` | Amanoba Pattern Contract Inventory | 3.9 KB |
...
| `docs/quality/PHASE_2_AUDIT_TRACKER.md` | PHASE 2 AUDIT - COURSES 2-8 | 3.4 KB |
| `docs/quality/QUALITY_SECURED_PROCESSING_COMPLETE.md` | ✅ Quality-Secured Processing - COMPLETE | 2.9 KB |
...
| `docs/sso/enable_sso.md` | SSO Integration Guide (Amanoba) | 4.3 KB |
...
| `docs/sso/SSO_ENVIRONMENT_VARIABLES.md` | SSO Environment Variables | 6.3 KB |
| `docs/sso/SSO_FOUNDATION_COMPLETE.md` | SSO Foundation - Phase 1 Complete ✅ | 5.6 KB |
| `docs/sso/SSO_IMPLEMENTATION_DETAILS.md` | SSO Implementation Details — Amanoba Platform | 14.9 KB |
| `docs/sso/SSO_INTEGRATION_REQUIREMENTS.md` | SSO Integration Requirements & Learnings | 9.7 KB |
| `docs/sso/SSO_MIGRATION_COMPLETE.md` | SSO Migration Complete - Cleanup Guide | 4.3 KB |
| `docs/sso/SSO_NONCE_FIX_INSTRUCTIONS.md` | SSO Nonce Error - Fix Instructions | 6.1 KB |
| `docs/sso/SSO_REDIRECT_URIS.md` | SSO Redirect URIs Configuration | 2.4 KB |
| `docs/sso/SSO_SCOPE_FIX.md` | SSO Scope Error Fix | 2.6 KB |
| `docs/sso/SSO_TROUBLESHOOTING.md` | SSO Troubleshooting Guide | 4.9 KB |
| `docs/status/MIGRATION_COMPLETE.md` | Page Migration to [locale] Structure - Complete | 5.7 KB |
| `docs/status/MIGRATION_PHASE_1_COMPLETE.md` | DATABASE MIGRATION PHASE 1 - FINAL STATUS | 10.9 KB |
