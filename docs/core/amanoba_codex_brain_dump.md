...
- Current continuation also converted the public profile page, profile certificate page, admin course-family list, admin dashboard, admin payments, admin settings, and admin certificate-management list to Mantine primitives and Tabler icons.
...
- The largest remaining Mantine-only gaps are now the course detail internals, admin questions/achievement editor surfaces, analytics/surveys/players/games/rewards admin lists, and game/challenge/reward chrome.
