...
**Primary focus**: For **appearance in AI chat results** (ChatGPT, Perplexity, Google AI Overview, etc.), see **`docs/features/GEO_IMPROVEMENT_PLAN.md`**. This doc covers traditional search engine optimization (Google/Bing SERPs); many GEO actions (sitemap, structured data, crawlability) also help SEO.
