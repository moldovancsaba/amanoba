...
- [ ] If using shorts: ensure shorts are draft until published and inherit the correct CCS (`docs/2026-01-27_RAPID_CHILDREN_COURSES_ACTION_PLAN_AND_HANDOVER.md`).
