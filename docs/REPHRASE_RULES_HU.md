...
**Purpose**: Per-locale rules for rephrasing quiz questions and options to native Hungarian (grammar, understandability). See `docs/2026-01-31_MESSY_CONTENT_AUDIT_AND_GRAMMAR_PLAN.md` § 7.
