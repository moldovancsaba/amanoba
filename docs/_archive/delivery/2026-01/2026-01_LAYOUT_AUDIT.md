...
| §2 Documentation layout | ✅ Resolved | ARCHITECTURE.md "TBD" removed; deliverable to fill baseline: `docs/_archive/tasklists/DOCUMENTATION_AUDIT_JANUARY__2026-01-28.md` item 1. |
...
**Finding 1 (resolved):** ARCHITECTURE.md Performance Targets "TBD" was replaced with "—" and a footnote. The requirement to measure and fill the baseline is in `docs/_archive/tasklists/DOCUMENTATION_AUDIT_JANUARY__2026-01-28.md` item 1.
...
**Tasklist**: Action items are recorded in **`docs/_archive/tasklists/LAYOUT_AUDIT_JANUARY__2026-01-28.md`**. Work in order P1 → P2 → P3.
