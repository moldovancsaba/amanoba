...
| Placeholders (layout grammar §2) | ✅ Resolved | TBD removed from ARCHITECTURE, DEPLOYMENT, TECH_STACK, RELEASE_NOTES (tail removed). Delivery requirements in `docs/_archive/tasklists/DOCUMENTATION_AUDIT_JANUARY__2026-01-28.md`. Planning docs use "—" where applicable. |
...
**Status (resolved):** TBD text has been removed from core docs. Delivery requirements (e.g. measure baseline, set domain) are in `docs/_archive/tasklists/DOCUMENTATION_AUDIT_JANUARY__2026-01-28.md`.
...
**Audit:**
- Dated feature docs present (e.g. 2026-01-28_*, 2026-01-30_*). Tasklists in `docs/_archive/tasklists/` with `*__YYYY-MM-DD*.md`. ✅
...
**Status:** All TBD/placeholder text has been **removed** from the documentation (replaced with "—" or removed). The corresponding **delivery requirements** are in **`docs/_archive/tasklists/DOCUMENTATION_AUDIT_JANUARY__2026-01-28.md`**.
