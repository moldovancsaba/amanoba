...
This folder holds **non-canonical** documentation that we keep only for **historical context**:

- Dated delivery / audit docs
- Generated tasklists and snapshots
- One-off reports, execution logs, and superseded plans
