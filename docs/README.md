...
This documentation was normalized into domain folders so work can continue without hunting through a flat file list.
...
- `docs/status` - project/phase/migration completion status
- `docs/handoff` - handoff and board workflow docs
