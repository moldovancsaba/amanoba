/**
 * Publish (activate) SCRUMMASTER_LESZEK_2026_HU Day 28 lesson (backup-first).
 */
...
async function main() {
  ...
  const backupFile = join(backupDir, `publish-day-28__${stamp}.json`);
