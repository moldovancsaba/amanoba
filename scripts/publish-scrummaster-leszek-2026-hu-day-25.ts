/**
 * Publish (activate) SCRUMMASTER_LESZEK_2026_HU Day 25 lesson (backup-first).
 */
...
async function main() {
  ...
  const backupFile = join(backupDir, `publish-day-25__${stamp}.json`);
