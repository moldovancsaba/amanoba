/**
 * Publish (activate) SCRUMMASTER_LESZEK_2026_HU Day 21 lesson (backup-first).
 */
...
async function main() {
  ...
  const backupFile = join(backupDir, `publish-day-21__${stamp}.json`);
