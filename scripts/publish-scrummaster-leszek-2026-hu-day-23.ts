/**
 * Publish (activate) SCRUMMASTER_LESZEK_2026_HU Day 23 lesson (backup-first).
 */
...
async function main() {
  ...
  const backupFile = join(backupDir, `publish-day-23__${stamp}.json`);
