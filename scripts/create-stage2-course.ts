...
async function create() {
  ...
  // Get brand (use slug, not brandId)
  ...
  const course = await Course.create({
    ...
    description: 'Build practical AI skills. Learn when to use AI, how to work with AI tools, and apply best practices to real-world problems. Perfect for those who completed AI for Dummies.',
    language: 'en',
    ...
    lessons: Array.from({ length: 15 }, (_, i) => ({
      ...
      displayOrder: i + 1,
      content: `# Day ${i + 1}: AI Essentials\n\nLearn practical AI skills for day ${i + 1}.`,
      quizQuestions: [],
    })),
    lessonQuizPolicy: {
      enabled: true,
