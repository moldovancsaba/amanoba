/**
 * Clean Courses and Create "AI for dummies in a day"
 *
 * What: Safely removes all existing courses and creates the first quality-validated course
 * Why: Fresh start with a 1-day rapid course following the progressive strategy
 *
 * Usage: npx tsx --env-file=.env.local scripts/clean-and-create-ai-dummies-course.ts
 */
...
async function main() {
  console.log('🧹 Starting database cleanup and course creation...\n');

  await connectDB();

  // ============================================================================
  // Step 1: Backup existing courses (safety first)
  // ============================================================================
  console.log('📦 Step 1: Backing up existing courses...');
  ...
  const backupFile = path.join(backupDir, `courses-backup-${timestamp}.json`);
  ...
  console.log(`   ✅ Backed up ${existingCourses.length} courses to: ${backupFile}\n`);

  // ============================================================================
  // Step 2: Clean database
  // ============================================================================
  console.log('🗑️  Step 2: Cleaning database...');
  ...
  // ============================================================================
  // Step 3: Create "AI for dummies in a day" course
  // ============================================================================
  console.log('🎓 Step 3: Creating "AI for dummies in a day" course...\n');
  ...
  // ============================================================================
  // Step 4: Create Lesson 1 (Day 1)
  // ============================================================================
  console.log('📝 Step 4: Creating Day 1 lesson...\n');
  ...
  const lesson = await Lesson.create({
    ...
    content: `
# Lesson 1: AI Basics: What is AI and How Can You Use It?
...
**Stakeholders (optional):** Family or friends who want to understand what you're learning
...
### What it is not
AI is not magic, it's not sentient, and it doesn't have feelings or consciousness. It's software trained on data to recognize patterns and make predictions.
...
- **AI is everywhere**: Your phone's autocorrect, Netflix recommendations, and spam filters all use AI
- **AI is a tool**: It's designed to help humans, not replace them

### Key terms
- **AI (Artificial Intelligence):** Technology that can perform tasks requiring human-like intelligence
- **Machine Learning:** AI's ability to improve from experience without being explicitly programmed
...
- You're brainstorming ideas or solving problems
...
### Late signals
- You're spending hours on tasks AI could do in minutes
- You're stuck on a problem and not asking for help
- You're avoiding technology because it seems too complicated
...
- **Missed opportunities**: AI can solve problems you didn't know were solvable
...
2. **Start with a simple question** (e.g., "Explain photosynthesis like I'm 10 years old")
...
- Experiment and have fun - you can't break anything
...
3. Type this prompt: "Explain what artificial intelligence is using only simple words, as if you're talking to someone who has never heard of it before"
4. Read the response
...
**Expected result:** You've had your first AI conversation and understand the basics!
...
- [ ] I've tried at least one AI tool (ChatGPT or similar)
...
- AI News for Non-Technical People – https://www.technologyreview.com – Accessible AI news
    ...
    emailBody: `
# Welcome to AI for dummies in a day! 🎉

Today you'll discover what AI really is (no technical jargon, we promise!) and learn how to use it in your daily life.
...
**Your mission today:**
Create your Personal AI Use Case List - 3 specific ways you'll use AI tools.

**Time needed:** 45-60 minutes (take breaks if you need!)

**Ready to start?** Let's dive in!

Click here to begin: [Start Day 1](#)

You've got this! 💪

---
The Amanoba Team
P.S. Remember - AI is just a tool, and you're learning to use it. No pressure, just progress!
    `,
    quizConfig: {
      enabled: true,
      successThreshold: 70,
  ...
  // ============================================================================
  // Step 5: Create Quiz Questions (7 questions, quality-validated)
  // ============================================================================
  console.log('❓ Step 5: Creating quiz questions...\n');
  ...
  console.log('='.repeat(70));
  console.log('\n🎓 Next steps:');
  console.log('   1. Visit the platform and enroll in the course');
  console.log('   2. Test the lesson and quiz functionality');
  console.log('   3. If satisfied, this is your foundation for progressive strategy\n');

  logger.info({
    type: 'course_reset_complete',
