/**
 * Publish (activate) SCRUMMASTER_LESZEK_2026_HU Day 30 lesson (backup-first).
 */
...
async function main() {
  ...
  const backupFile = join(backupDir, `publish-day-30__${stamp}.json`);
