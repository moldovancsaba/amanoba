/**
 * Seed quiz questions for Sport Sales Network USA 2026 (EN)
 *
 * Purpose:
 * - Parse `docs/course_ideas/amanoba_course_sport_sales_network_usa_2026_questions.md`
 ...
 * - Populate the canonical lesson IDs that were created by `seed-sport-sales-network-usa-2026-en.ts`.
 */
...
const QUIZ_DOC_PATH = 'docs/course_ideas/amanoba_course_sport_sales_network_usa_2026_questions.md';
...
async function main() {
  ...
  if (!course) {
    throw new Error(`Course ${COURSE_ID} not found (run seed:sport-sales-network-usa-2026-en first)`);
  }
