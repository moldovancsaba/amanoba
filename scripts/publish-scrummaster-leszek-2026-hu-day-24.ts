/**
 * Publish (activate) SCRUMMASTER_LESZEK_2026_HU Day 24 lesson (backup-first).
 */
...
async function main() {
  ...
  const backupFile = join(backupDir, `publish-day-24__${stamp}.json`);
