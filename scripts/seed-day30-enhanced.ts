  ...
  BG: [
    {
      ...
      correctIndex: 1,
      difficulty: QuestionDifficulty.EASY,
      category: "Майстор на Производителността",
      questionType: QuestionType.RECALL,
  ...
  PL: [
    {
      ...
      correctIndex: 1,
      difficulty: QuestionDifficulty.EASY,
      category: "Mistrz Produktywności",
      questionType: QuestionType.RECALL,
  ...
  PT: [
    {
      ...
      correctIndex: 1,
      difficulty: QuestionDifficulty.EASY,
      category: "Mestre de Produtividade",
      questionType: QuestionType.RECALL,
