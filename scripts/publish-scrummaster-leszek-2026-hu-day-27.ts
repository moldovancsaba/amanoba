/**
 * Publish (activate) SCRUMMASTER_LESZEK_2026_HU Day 27 lesson (backup-first).
 */
...
async function main() {
  ...
  const backupFile = join(backupDir, `publish-day-27__${stamp}.json`);
