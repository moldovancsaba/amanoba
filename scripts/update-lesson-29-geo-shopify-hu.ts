/**
 * Update Lesson 29 for GEO_SHOPIFY_30 (Hungarian) - Quality Fix
 */
...
<ul>
<li>ChatGPT Shopping: <a href="https://help.openai.com/en/articles/11129490-shopping-with-chatgpt-search" target="_blank" rel="noreferrer">https://help.openai.com/en/articles/11129490-shopping-with-chatgpt-search</a></li>
<li>Microsoft Copilot Merchant Program: <a href="https://www.microsoft.com/en-us/microsoft-copilot/blog/2025/04/18/introducing-the-copilot-merchant-program/" target="_blank" rel="noreferrer">https://www.microsoft.com/en-us/microsoft-copilot/blog/2025/04/18/introducing-the-copilot-merchant-program/</a></li>
  ...
  emailSubject: 'GEO Shopify – 29. nap: Merchant programok',
...
async function updateLesson29() {
  try {
    ...
    const course = await Course.findOneAndUpdate(
      { courseId: COURSE_ID },
      {
        $set: {
          ...
          xpConfig: { completionXP: 500, lessonXP: 29 },
    ...
    const lesson = await Lesson.findOneAndUpdate(
      { lessonId },
      {
        $set: {
          ...
          language: 'hu', title: UPDATED_LESSON_29.title, content: UPDATED_LESSON_29.content,
    ...
    console.log(`✅ Lesson 29 updated successfully`);
