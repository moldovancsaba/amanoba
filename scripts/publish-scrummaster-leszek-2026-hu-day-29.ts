/**
 * Publish (activate) SCRUMMASTER_LESZEK_2026_HU Day 29 lesson (backup-first).
 */
...
async function main() {
  ...
  const backupFile = join(backupDir, `publish-day-29__${stamp}.json`);
