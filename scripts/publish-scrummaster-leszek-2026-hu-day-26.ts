/**
 * Publish (activate) SCRUMMASTER_LESZEK_2026_HU Day 26 lesson (backup-first).
 */
...
async function main() {
  ...
  const backupFile = join(backupDir, `publish-day-26__${stamp}.json`);
