...
export interface IEventLog extends Document {
  ...
  eventType: 'player_registered' | 'game_played' | 'achievement_unlocked' | 'points_earned' | 'points_spent' | 'level_up' | 'streak_started' | 'streak_broken' | 'streak_milestone' | 'challenge_completed' | 'reward_redeemed' | 'premium_purchased' | 'login' | 'logout' | 'practice_hub_viewed' | 'practice_hub_recommendation_opened' | 'practice_hub_completion_recorded' | 'practice_hub_reward_granted' | 'system';
...
const EventLogSchema = new Schema<IEventLog>(
  {
    ...
    eventType: {
      type: String,
      enum: {
        values: ['player_registered', 'game_played', 'achievement_unlocked', 'points_earned', 'points_spent', 'level_up', 'streak_started', 'streak_broken', 'streak_milestone', 'challenge_completed', 'reward_redeemed', 'premium_purchased', 'login', 'logout', 'practice_hub_viewed', 'practice_hub_recommendation_opened', 'practice_hub_completion_recorded', 'practice_hub_reward_granted', 'system'],
