/**
 * Admin API: Reset Courses and Create "AI for dummies in a day"
 *
 ...
 *
 * Usage: POST /api/admin/courses/reset-and-create-ai-dummies
 */

import { NextRequest, NextResponse } from 'next/server';
import { auth } from '@/auth';
import connectDB from '@/lib/mongodb';
import { Course, Lesson, QuizQuestion, CourseProgress, Certificate, CertificateEntitlement } from '@/lib/models';
...
export async function POST(request: NextRequest) {
  try {
    ...
    // ============================================================================
    // Step 1: Count existing courses (safety check)
    // ============================================================================
    const existingCourseCount = await Course.countDocuments();
    
    logger.info({
      type: 'course_reset_start',
      existingCourses: existingCourseCount,
    ...
    logger.info({
      ...
      deletedEntitlements: deletedEntitlements.deletedCount,
    });
...
P.S. Remember - AI is just a tool, and you are learning to use it. No pressure, just progress!
    ...
    logger.info({
      ...
      deletedRecords: {
        ...
        certificates: deletedCertificates.deletedCount,
        entitlements: deletedEntitlements.deletedCount,
      },
    });
