...
export async function GET(
  ...
  try {
    ...
    // Why: Only fetch achievement status, don't re-check (that happens during game completion)
    // Removed opportunistic check that was causing false unlocks with incomplete context
