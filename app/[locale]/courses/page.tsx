          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {courses.map((course) => (
              <LocaleLink
                ...
                className="block bg-brand-white rounded-xl p-6 border-2 border-brand-accent hover:shadow-lg transition-all"
              >
                {course.thumbnail && (
                ...
                <p className="text-brand-darkGrey text-sm mb-4 line-clamp-2">
                  {course.description}
                </p>
