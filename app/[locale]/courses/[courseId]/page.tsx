  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-brand-black flex items-center justify-center">
        <div className="text-brand-white text-xl">Loading course...</div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-brand-black flex items-center justify-center">
        <div className="text-center">
          <h2 className="text-2xl font-bold text-brand-white mb-4">Course not found</h2>
          <LocaleLink
            href="/courses"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-brand-white rounded-xl p-6 border-2 border-brand-accent">
              <h2 className="text-2xl font-bold text-brand-black mb-4">About This Course</h2>
              <p className="text-brand-darkGrey leading-relaxed">{course.description}</p>
            </div>

            <div className="bg-brand-white rounded-xl p-6 border-2 border-brand-accent">
              <h2 className="text-2xl font-bold text-brand-black mb-4">What You'll Learn</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-6 h-6 text-brand-accent flex-shrink-0 mt-1" />
                  <div>
                    <h3 className="font-bold text-brand-black">30 Daily Lessons</h3>
                    <p className="text-sm text-brand-darkGrey">Structured learning over 30 days</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <Award className="w-6 h-6 text-brand-accent flex-shrink-0 mt-1" />
                  <div>
                    <h3 className="font-bold text-brand-black">{course.pointsConfig.completionPoints} Points</h3>
                    <p className="text-sm text-brand-darkGrey">Earn points for completion</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <BookOpen className="w-6 h-6 text-brand-accent flex-shrink-0 mt-1" />
                  <div>
                    <h3 className="font-bold text-brand-black">Email Delivery</h3>
                    <p className="text-sm text-brand-darkGrey">Daily lessons sent to your email</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <Play className="w-6 h-6 text-brand-accent flex-shrink-0 mt-1" />
                  <div>
                    <h3 className="font-bold text-brand-black">Interactive Assessments</h3>
                    <p className="text-sm text-brand-darkGrey">Test your knowledge with games</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-brand-white rounded-xl p-6 border-2 border-brand-accent sticky top-6">
              <div className="space-y-4">
                <div>
                  ...
                  <div className="text-xl font-bold text-brand-black">{course.durationDays} days</div>
                </div>
                ...
                <div>
                  ...
                  <div className="text-xl font-bold text-brand-black">
                    {course.pointsConfig.completionPoints} points
                  </div>
                </div>
                    ...
                    <div className="bg-green-500/20 border border-green-500 rounded-lg p-3">
                      ...
                      {enrollment.progress && (
                        <div className="text-sm text-brand-darkGrey">
                          <div>Day {enrollment.progress.currentDay} of {course.durationDays}</div>
