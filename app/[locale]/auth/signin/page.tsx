...
export default async function SignInPage({
  ...
  const googleButtonLabel = locale === 'hu' ? 'Folytatás Google-lel' : 'Continue with Google';
  const otherWaysLabel = locale === 'hu' ? 'Bejelentkezés más módon' : 'Sign in another way';
          ...
          {process.env.SSO_CLIENT_ID && (
            <>
              <a
                ...
                className="w-full bg-brand-white hover:bg-brand-neutral-100 text-brand-black border-2 border-brand-darkGrey/20 font-semibold text-lg py-4 px-6 rounded-xl transition-colors duration-200 flex items-center justify-center gap-3 shadow-md hover:shadow-lg block text-center"
              >
