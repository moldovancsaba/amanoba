            ...
            <>
              <a
                ...
                className={cn(
                  ...
                  'w-full border-2 justify-center gap-3 text-center shadow-md hover:shadow-lg'
                )}
              >
              ...
              <a
                ...
                className={cn(buttonVariants({ variant: 'default', size: 'lg' }), 'w-full justify-center gap-3 text-center')}
              >
                <svg
                  className="w-6 h-6"
                  fill="none"
